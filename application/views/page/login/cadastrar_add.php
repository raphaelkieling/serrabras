           ...
           <?php 
            ...
            <?= form_open_multipart('/cadastrarinfo');?> 
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="nomeUsuario" id="nomeUsuario" placeholder="Dieter Marschall">
              </div>
              <div class="form-group">
                <label for="Empresa">Empresa</label>
                <input type="text" class="form-control" name="empresa" id="Empresa" placeholder="SerraBras Comércio de Madeiras">
              </div>
              <div class="form-group">
                <label for="endereco">Endereço</label>
                <input type="text" name="endereco" class="form-control" id="endereco" placeholder="R. Alfredo Girardi, 570 - Vila Nova">
              </div>
              <div class="form-group">
                <label for="cidadeEStado">Cidade / Estado</label>
                <input type="text" class="form-control" name="cidadeEstado" id="cidadeEstado" placeholder="Rio Negrinho - SC">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="email" name="email" class="form-control" id="emailUsuario" placeholder="Digite o e-mail principal">
              </div>
              <div class="form-group">
                <label for="Telefone">Telefone</label>
                <input type="phone" name="telefone" class="form-control" id="Telefone" placeholder="(00) 0000-0000">
              </div>
              <div class="form-group">
