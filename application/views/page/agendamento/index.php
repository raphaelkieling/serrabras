    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="form-group">
                ...
                <input id="cadastrante" name="cadastrante" readonly class="form-control" value="<?=$user['email']?>">
            </div>
            <div class="row">
                <div class="col-md-6">
                    <!--Definir local-->
            ...
            <div class="row">
                <div class="col-md-4">
                    <a href="/"><button class="form-control btn btn-default btn-success">Agendar</button></a>
                </div>
            </div>
            <br>
            <br>
