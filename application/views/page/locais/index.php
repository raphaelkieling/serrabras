				...
				<div class="panel-body">
					...
					<div class="row">
						<div class="col-md-6 col-xs-6">
							<div class="form-group">
								<label for="horario_inicial">Hr Inicial</label>
								<select class="form-control horario_inicial" onchange="criaHoras()" name="horario_inicial">
						...
						<div class="col-md-4 col-xs-4">
							<div class="form-group">
								<label for="horario_inicial_minutos">Minutos</label>
								<select class="form-control horario_inicial_minutos" onchange="criaHoras()" name="horario_inicial_minutos">
					...
					<div class="row">
						<div class="col-md-12 col-xs-12">
							<div class="form-group">
								...
								<div class="row">
									<div class="col-md-3">
										<input type="number" class="form-control limitador_input" onchange="mudaRangeRange();">
									</div>
									<div class="col-md-9">
										<input type="range" onchange="criaHoras();mudaRangeInput();" class="form-control limitador" name="limitador" max="12" value="0">
									</div>
								</div>
							</div>
						</div>
								...
								<div class="modal-dialog" role="document">
									...
									<div class="modal-body">
										...
										<div class='alert alert-success'>
											Nome: <?=$locais['nome']?>
											<br>
											Hora Inicial: <?=$locais['horario_inicial']?>
											<br>
											Limite: <?=$locais['limite']?>
											<br>
											Dias: <?=diasLabel($locais['dias'])?>
										</div>

										<div class="form-group">
											<label for="nome">Novo nome do local</label>
											<input name="nome_modal" type="text" class="form-control" value="<?=$locais['nome']?>">
										</div>
										<div class="row">
											<div class="col-md-6 col-xs-6">
												<div class="form-group">
										...
										<div class="row">
											<div class="col-md-12 col-xs-12">
												<div class="form-group">
													<label for="limitador">Novo limite de blocos de horas</label>
													<input type="number" class="form-control limitador_input" name="limitador_modal" placeholder="O limite atual - <?= $locais['limite']?>">
												</div>
											</div>
										</div>
										<!-- Fechamento da ROW horario final -->
										<div class="row container">
											<br>
											<div class="form-group">
												<label for="semana">Novos dias da Semana</label>
												<small><br>Quais os dias que estarão em funcionamento nessa atualizaçao?</small>
												<br>
												<input type="checkbox" name="segunda"> Segunda-feira<br>
												<input type="checkbox" name="terca"> Terça-feira<br>
												<input type="checkbox" name="quarta"> Quarta-feira<br>
